...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔍 Group​​​​​', url=f'https://t.me/+ypyjHmE6TZ0wNTRl')
            ],
            [
                InlineKeyboardButton('🙆🏻 Hᴇʟᴘ 🦾', url=f"https://t.me/{temp.U_NAME}?start=help"),
            ],[
            InlineKeyboardButton('⪦ 𝕄𝕆𝕍𝕀𝔼 ℂℍ𝔸ℕℕ𝔼𝕃 ⪧', url='https://t.me/movieadda76')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Gʀᴏᴜᴘ', url=f'https://t.me/+ypyjHmE6TZ0wNTRl')
            ],[
            ...
            InlineKeyboardButton('💸 E𝐚𝐫𝐧 M𝐨𝐧𝐞𝐲 💸', callback_data="shortlink_info")
                ...
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE YT Channel 🦋", url='https://www.youtube.com/@TechBro-kd8yk'
                )
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url='https://t.me/+Uv-5RymSbysyMTE1')
                            ]
                        ]
                    )
                    )
